    ...
    let videoId;
    const url = `https://us-central1-gearingup-education-platform.cloudfunctions.net/api/get-milestone?courseId=${courseId}&milestoneId=${milestoneId}`;
        ...
        user.getIdToken().then((idToken) => {
          ...
          fetch(url, {
            ...
            .then((json) => {
              ...
              const { homeworks } = chapter;
              const homeworkTitles = document.querySelectorAll('.homework');
              const homeworkLinks = document.querySelectorAll('.homework-card');
              homeworkLinks.forEach(
                (elementLink, index) => (elementLink.href = homeworks[index].url)
              );
              homeworkTitles.forEach(
                (el, index) => (el.innerHTML = homeworks[index].title)
              );
              ...
              document
                ...
                .forEach(
                  (x) =>
                    (x.href = `/course?milestone=${milestone.id}&chapter=${nextChapter.id}`)
                );
              document.querySelector('#milestoneName').innerHTML = milestone.title;
    ...
    el.parentElement.querySelector('.video-name').innerHTML;
    ...
    function getQuiz(vimeoId) {
      ...
      const url = `https://us-central1-gearingup-education-platform.cloudfunctions.net/api/get-quiz?vimeoId=${vimeoId}&courseId=${courseId}`;
      firebase.auth().onAuthStateChanged((user) => {
        if (user) {
          user.getIdToken().then((idToken) => {
            fetch(url, {
              ...
              .then((json) => {
                ...
                if (quiz.question_1) {
                  ...
                  question1.innerHTML = ` <div class="bodyl-regular bottom-margin-64px">
                 ...
                 <div id="quizQuestion" class="headingm-regular bottom-margin-32px">
                  ...
                  if (quiz.answer_1_1) {
                    ...
                    answer11.innerHTML = `<div class="quiz-pill">
                 ...
                 <div class="quiz-text">${quiz.answer_1_1}</div>`;
                  ...
                  if (quiz.answer_1_2) {
                    ...
                    answer12.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                 ...
                 <div class="quiz-text">${quiz.answer_1_2}</div>`;
                  ...
                  if (quiz.answer_1_3) {
                    ...
                    answer13.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                ...
                if (quiz.question_2) {
                  ...
                  question2.innerHTML = ` <div class="bodyl-regular bottom-margin-64px">
                    Answer this question to quickly review some of the material from the video.
                  </div>
                  <div class="question-number">
                    <div class="question-text-number">1</div>
                 ...
                 <div id="quizQuestion" class="headingm-regular bottom-margin-32px">
                  ...
                  if (quiz.answer_2_1) {
                    ...
                    answer21.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                 ...
                 <div class="quiz-text">${quiz.answer_2_1}</div>`;
                  ...
                  if (quiz.answer_2_2) {
                    ...
                    answer22.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                 ...
                 <div class="quiz-text">${quiz.answer_2_2}</div>`;
                  ...
                  if (quiz.answer_2_3) {
                    ...
                    answer23.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                ...
                if (quiz.question_3) {
                  ...
                  question3.innerHTML = ` <div class="bodyl-regular bottom-margin-64px">
                    Answer this question to quickly review some of the material from the video.
                  </div>
                  <div class="question-number">
                    <div class="question-text-number">1</div>
                 ...
                 <div id="quizQuestion" class="headingm-regular bottom-margin-32px">
                  ...
                  if (quiz.answer_3_1) {
                    ...
                    answer31.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                 ...
                 <div class="quiz-text">${quiz.answer_3_1}</div>`;
                  ...
                  if (quiz.answer_3_2) {
                    ...
                    answer32.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
                 ...
                 <div class="quiz-text">${quiz.answer_3_2}</div>`;
                  ...
                  if (quiz.answer_3_3) {
                    ...
                    answer33.innerHTML = `<div class="quiz-pill">
                   <div class="quiz-embed w-embed">
    ...
    function actualQuiz() {
      ...
      $('.question-text-number').html((i) => 1 + i);

      const questionItem = $('.question');
      const totalQuestions = questionItem.length;
      let gameOver = false;
      ...
      function updateUi() {
        ...
        const progress = 100 * ($('.is--answered').length / totalQuestions);
      ...
      function showAnswer(element) {
        const parentItem = $(element).closest('.question');
        $(element).closest('.answer-options').addClass('is--answered');
        const correctAnswer = element.querySelector('.true');
        if (correctAnswer) {
      ...
      function nextQuestion() {
        if (gameOver == false) {
          const currentQuestion = $('.question.is--current-question');
